    ...
    >
      <div className="flex flex-col gap-6 items-center">
        <Typography className="max-w-2xl" variant="h1">
          Una suscripción para todos tus proyectos de diseño
        </Typography>
        <Typography className="max-w-2xl" variant="h5">
          Escala y delega todas las operaciones de diseño de tu organización con
          un servicio de diseño confiable y sin complicaciones.
        </Typography>
        <Link
          href="#"
        >
      ...
      <div className="flex flex-col md:pt-24 md:gap-36 gap-24 items-center">
        ...
        <div className="flex flex-col gap-6 items-center">
          ...
          <div>
            Conoce al instante a tu próximo equipo creativo y diseñemos hoy
            mismo tu primer pedido en Grayola, 100% gratis.
          </div>
          <Link
            href="#"
          >
